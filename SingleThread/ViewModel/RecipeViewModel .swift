...
import Foundation
import UIKit
//instantiating a REST_Request that has a singleton in it, and it is a ultility class. SO we should only have 1 instance of the rest request in the app, SO we make the rest request a singleton as well
